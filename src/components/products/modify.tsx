...
export default function ProductAction(props: Partial<productComponentsTypes>) {
    const {
        popUp, setPopUp, product, setProduct,
        picture, onChange, pictureAction, method,
        categories, loading
    } = props
                                        ...
                                        <div key={index} className="w-full flex flex-col gap-2">
                                            ...
                                            <div className="w-full flex gap-4">
                                                <div className="w-1/2 flex flex-col gap-4">
                                                    {/* <!-- Add new picture --> */}
                                                    <Input type={input?.type} id={input?.inputName} placeholder={input?.placeHolder} name={input?.inputName} onChange={onChange} value={picture} />
