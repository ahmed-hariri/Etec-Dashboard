...
import { contextTyes, ordersTypes } from "@/types";
...
export const shareStates = createContext<contextTyes>(initialState);
...
export default function ShareProvider({ children }: { children: React.ReactNode }) {
    ...
    return <>
        <shareStates.Provider value={{ cards, chartData, orders, links, inputs }}>
            {children}
