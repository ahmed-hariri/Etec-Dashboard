...
export default function Navbar() {
    ...
    return <>
        <div className="w-full lg:w-auto h-screen flex absolute lg:relative">
            <div className="w-full h-full relative flex justify-center lg:justify-start">
                <div className="w-auto flex lg:hidden justify-between items-center px-[18px] py-[13px] mb-7 text-[25px] shadow-[#00000050] shadow-md text-black rounded-full bg-white gap-5 bottom-0 absolute z-20">
                ...
                <div className={`w-full py-8 px-[37px] lg:p-6 lg:pr-20 bg-white ${showAllContent ? "flex" : "hidden lg:flex"} flex-col justify-between border-r border-gray-200`}>
