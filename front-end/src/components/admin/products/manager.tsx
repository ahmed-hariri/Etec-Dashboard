...
export default function ProductsComponents() {
    ...
    const handelProduct = (id: string | null): void => {
        ...
        if (findProduct) {
            setPopUp?.({ modify: true, productId: id ?? null })
            setProduct({
    ...
    return <>
        <section className="w-full lg:w-[80%] px-8 py-5 flex justify-center">
            <div className="w-full lg:max-w-[70rem] flex flex-col gap-8">
                ...
                {/* <!-- Product Form --> */}
                <ProductForm
                    product={product} setProduct={setProduct} pictureValue={picture}
        ...
        <ProductAction
            ...
            product={product} setProduct={setProduct} categories={categories} onChange={handleInputChange} pictureAction={pictureAction}
        />
    </>
}